...
const UpdateProduct = () => {
    ...
    const [formData, setFormData] = useState({ name: "", category: "", price: "", picture: "" });
  ...
  <img src="/images/sidebar-bg.jpg" alt="Sidebar Background" style={{ width: '100%', height: '250px', objectFit: 'cover', borderRadius: '10px' }} />
            ...
            <div className="flex-grow-1 p-4" style={{ marginLeft: '250px' }}>
                ...
                <form onSubmit={handleSubmit} className="bg-white p-4 rounded shadow-lg w-100" style={{ maxWidth: '500px' }}>
                    ...
                    <div className="mb-3">
                        <input type="number" name="price" value={formData.price} onChange={handleChange} placeholder="Price" className="form-control" required />
                    </div>
